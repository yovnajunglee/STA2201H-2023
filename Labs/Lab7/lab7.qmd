...
ggplot(lka, aes(year, logit_ratio)) +
  ...
  #                ymax = logit_ratio + se, 
  #                fill =  source), alpha = 0.1) + 
  geom_line(data = res, aes(year, .value, col = "RW1"), linewidth =.2) + 
  geom_ribbon(data = res, aes(y = .value, ymin = .lower, ymax = .upper, fill = "RW1"), alpha = 0.2)+
  geom_line(data = res_p, aes(year, .value,col="RW1 projections"), linewidth =.2) + 
  geom_ribbon(data = res_p, aes(y = .value, ymin = .lower, ymax = .upper,fill="RW1 projections"), alpha = 0.2) +
  
   geom_line(data = res2, aes(year, .value, col = "RW2")) + 
  geom_ribbon(data = res2, aes(y = .value, ymin = .lower, ymax = .upper, fill = "RW2"), alpha = 0.2)+
